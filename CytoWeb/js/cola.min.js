    ...
    return function() {
        ...
        3: [function(a, b, c) {
            ...
            function f(a, b, c) {
                ...
                return h.forEach(function(a, b) {
                    ...
                    h.push(a),
                    void 0 !== a.leaves && a.leaves.forEach(function(a) {
                        return f.push({
                            source: b,
                            target: a.index
                        })
                ...
                g = function(a) {
                    function b() {
                        ...
                        return b.drag = function() {
                            if (!a)
                                var a = d3.behavior.drag().origin(f.Layout.dragOrigin).on("dragstart.d3adaptor", f.Layout.dragStart).on("drag.d3adaptor", function(a) {
                                    f.Layout.drag(a, d3.event),
                                    c.resume()
            ...
            var e = a("./layout"),
                f = function(a) {
                    function b(b) {
                        var c = a.call(this) || this;
                        c.d3Context = b,
                        c.event = b.dispatch(e.EventType[e.EventType.start], e.EventType[e.EventType.tick], e.EventType[e.EventType.end]);
                        var d = c;
                        return c.drag = function() {
                            if (!a)
                                var a = b.drag().subject(e.Layout.dragOrigin).on("start.d3adaptor", e.Layout.dragStart).on("drag.d3adaptor", function(a) {
                                    e.Layout.drag(a, b.event),
                                    d.resume()
        ...
        7: [function(a, b, c) {
            ...
            var d = function() {
                ...
                return a.prototype.add = function(a, b) {
                    ...
                    for (var a in this.locks)
                        return !1;
                    return !0
                }, a.prototype.apply = function(a) {
                    for (var b in this.locks)
                        a(Number(b), this.locks[b])
                }, a
            }();
            c.Locks = d;
            var e = function() {
                function a(a, b, c) {
                    ...
                    for (this.minD === Number.MAX_VALUE && (this.minD = 1), h = this.k; h--;) {
                        for (this.g[h] = new Array(e), this.H[h] = new Array(e), g = e; g--;)
                            this.H[h][g] = new Array(e);
                        this.Hd[h] = new Array(e),
                        this.a[h] = new Array(e),
                        this.b[h] = new Array(e),
                        this.c[h] = new Array(e),
                        this.d[h] = new Array(e),
                        this.e[h] = new Array(e),
                        this.ia[h] = new Array(e),
                        this.ib[h] = new Array(e),
                        this.xtmp[h] = new Array(e)
                    }
                }
                return a.createSquareMatrix = function(a, b) {
                                ...
                                if (i !== j) {
                                    ...
                                    if (q > 1 && o > p || !isFinite(p))
                                        ...
                                        var r = p * p,
                                            ...
                                            t = o * o * o,
                                            u = 2 * -q / (r * t);
                                        for (isFinite(s) || console.log(s), d = 0; d < this.k; ++d)
                                            this.g[d][i] += e[d] * s,
                                            g[d] -= this.H[d][i][j] = u * (t + p * (f[d] - l) + o * l)
                                    }
                                }
                            for (d = 0; d < this.k; ++d)
                                h = Math.max(h, this.H[d][i][i] = g[d])
                        }
                        for (var v = this.snapGridSize / 2, w = this.snapGridSize, x = this.snapStrength, y = x / (v * v), z = this.numGridSnapNodes, i = 0; i < z; ++i)
                            for (d = 0; d < this.k; ++d) {
                                var A = this.x[d][i],
                                    B = A / w,
                                    C = B % 1,
                    ...
                    for (var c = 0, d = 0, e = 0; e < this.k; ++e)
                        c += a.dotProd(this.g[e], b[e]),
                        a.rightMultiply(this.H[e], b[e], this.Hd[e]),
                        d += a.dotProd(b[e], this.Hd[e]);
                    return 0 !== d && isFinite(d) ? 1 * c / d : 0
                }, a.prototype.reduceStress = function() {
                    this.computeDerivatives(this.x);
                    for (var a = this.computeStepSize(this.g), b = 0; b < this.k; ++b)
                        this.takeDescentStep(this.x[b], this.g[b], a);
                    return this.computeStress()
                }, a.copy = function(a, b) {
                    for (var c = a.length, d = b[0].length, e = 0; e < c; ++e)
                        for (var f = 0; f < d; ++f)
                            b[e][f] = a[e][f]
                }, a.prototype.stepAndProject = function(b, c, d, e) {
                    a.copy(b, c),
                    this.takeDescentStep(c[0], d[0], e),
                    this.project && this.project[0](b[0], b[1], c[0]),
                    this.takeDescentStep(c[1], d[1], e),
                    this.project && this.project[1](c[0], b[1], c[1]);
                    for (var f = 2; f < this.k; f++)
                        this.takeDescentStep(c[f], d[f], e)
                    ...
                    if (this.stepAndProject(a, b, this.g, d), this.project) {
                        ...
                        e = Math.max(.2, Math.min(e, 1)),
                        this.stepAndProject(a, b, this.e, e)
                    }
                }, a.prototype.run = function(a) {
                    for (var b = Number.MAX_VALUE, c = !1; !c && a-- > 0;) {
                        var d = this.rungeKutta();
                        c = Math.abs(b / d - 1) < this.threshold,
                        b = d
                    }
                    return b
                    ...
                    a.mid(this.x, this.a, this.ia),
                    this.computeNextPosition(this.ia, this.b),
                    a.mid(this.x, this.b, this.ib),
                    ...
                    for (var a = 0, b = 0, c = this.n - 1; b < c; ++b)
                        for (var d = b + 1, e = this.n; d < e; ++d) {
        ...
        8: [function(a, b, c) {
            ...
            function g(a) {
                ...
                if (h.push(c[0]), g === e - 1)
                    ...
                    for (b = e - 2; b >= 0 && c[b].x === k; b--)
                        ;
                    for (i = b + 1, b = g; ++b <= i;)
                        if (!(d(c[0], c[i], c[b]) >= 0 && b < i)) {
                            for (; h.length > 1 && !(d(h[h.length - 2], h[h.length - 1], c[b]) > 0);)
                                h.length -= 1;
                            0 != b && h.push(c[b])
                        }
                    j != i && h.push(c[j]);
                    var l = h.length;
                    for (b = i; --b >= g;)
                        if (!(d(c[j], c[g], c[b]) >= 0 && b > g)) {
                            for (; h.length > l && !(d(h[h.length - 2], h[h.length - 1], c[b]) > 0);)
                                h.length -= 1;
                            0 != b && h.push(c[b])
                        }
                }
            ...
            function j(a, b) {
                var c,
                    ...
                    i,
                    j = b.length - 1;
                if (f(a, b[1], b[0]) && !e(a, b[j - 1], b[0]))
                    return 0;
                for (c = 0, d = j;;) {
                    if (d - c == 1)
                        return e(a, b[c], b[d]) ? c : d;
                    if (g = Math.floor((c + d) / 2), (i = f(a, b[g + 1], b[g])) && !e(a, b[g - 1], b[g]))
                        return g;
                    h = e(a, b[c + 1], b[c]),
                    h ? i ? d = g : e(a, b[c], b[g]) ? d = g : c = g : i && f(a, b[c], b[g]) ? d = g : c = g
                }
            }
            function k(a, b) {
                var c,
                    ...
                    i,
                    j = b.length - 1;
                if (e(a, b[j - 1], b[0]) && !f(a, b[1], b[0]))
                    return 0;
                for (c = 0, d = j;;) {
                    if (d - c == 1)
                        return f(a, b[c], b[d]) ? c : d;
                    if (g = Math.floor((c + d) / 2), i = f(a, b[g + 1], b[g]), e(a, b[g - 1], b[g]) && !i)
                        return g;
                    h = f(a, b[c + 1], b[c]),
                    h ? i ? f(a, b[c], b[g]) ? d = g : c = g : d = g : i ? c = g : e(a, b[c], b[g]) ? d = g : c = g
                }
            }
            function l(a, b, c, d, e, f) {
                ...
                for (var i = !1; !i;) {
                    for (i = !0;;) {
                        if (g === a.length - 1 && (g = 0), e(b[h], a[g], a[g + 1]))
                            break;
                        ++g
                    }
                    for (;;) {
                        if (0 === h && (h = b.length - 1), f(a[g], b[h], b[h - 1]))
                            break;
                        --h,
                        i = !1
                    }
            ...
            function r(a, b) {
                for (var c = a.length - 1, e = b.length - 1, f = new B, g = 0; g < c; ++g)
                    for (var h = 0; h < e; ++h) {
                        var i = a[0 == g ? c - 1 : g - 1],
                            j = a[g],
                            k = a[g + 1],
            ...
            function u(a, b) {
                ...
                for (var c = 1, d = a.length; c < d; ++c) {
                    var e = a[c],
                        f = a[c - 1];
                    if (q(new y(f.x, f.y, e.x, e.y), b).length > 0)
                        return !0
                }
                return !1
            }
            ...
            c.isLeft = d,
            c.ConvexHull = g,
            c.clockwiseRadialSweep = h,
            c.tangent_PolyPolyC = l,
            c.LRtangent_PolyPolyC = m,
            c.RLtangent_PolyPolyC = n,
            c.LLtangent_PolyPolyC = o,
            c.RRtangent_PolyPolyC = p;
            var A = function() {
                function a(a, b) {
                    this.t1 = a,
                    this.t2 = b
                    ...
                    if (this.P = a, this.V = [], this.E = [], b)
                        ...
                        for (var c = a.length, d = 0; d < c; d++) {
                            for (var e = a[d], f = 0; f < e.length; ++f) {
                                ...
                                this.V.push(h),
                                f > 0 && this.E.push(new E(e[f - 1].vv, h))
                            }
                            e.length > 1 && this.E.push(new E(e[0].vv, e[e.length - 1].vv))
                        }
                        for (var d = 0; d < c - 1; d++)
                            for (var i = a[d], f = d + 1; f < c; f++) {
                                var j = a[f],
                                    k = r(i, j);
                                for (var l in k) {
                                    var m = k[l],
                ...
                return a.prototype.addEdgeIfVisible = function(a, b, c, d) {
                    ...
                    for (var d = 0; d < c; ++d)
                        if (d !== b) {
                            var e = this.P[d],
                                f = i(a, e);
                            this.addEdgeIfVisible(a, e[f.ltan], b, d),
                            this.addEdgeIfVisible(a, e[f.rtan], b, d)
                        }
                    return a.vv
                }, a.prototype.intersectsPolys = function(a, b, c) {
                    for (var d = 0, e = this.P.length; d < e; ++d)
                        if (d != b && d != c && q(a, this.P[d]).length > 0)
                            return !0;
                    return !1
                }, a
            }();
            c.TangentVisibilityGraph = F,
            c.tangents = r,
            c.polysOverlap = u
        }, {
            "./rectangle": 17
        ...
        9: [function(a, b, c) {
            ...
            var j = function() {
                function a(a, b, c) {
                    var e = this;
                    void 0 === c && (c = 12),
                    this.originalnodes = a,
                    this.groupPadding = c,
                    this.leaves = null,
                    this.nodes = a.map(function(a, c) {
                    ...
                    this.nodes.forEach(function(a) {
                        void 0 === a.parent && (a.parent = e.root, e.root.children.push(a.id)),
                        a.ports = []
                    }),
                    this.backToFront = this.nodes.slice(0),
                    this.backToFront.sort(function(a, b) {
                ...
                return a.prototype.avg = function(a) {
                    ...
                    for (var b = 0; a.parent !== this.root;)
                        b++,
                        a = a.parent;
                    return b
                }, a.prototype.midPoints = function(a) {
                    for (var b = a[1] - a[0], c = [a[0] - b / 2], d = 1; d < a.length; d++)
                        c.push((a[d] + a[d - 1]) / 2);
                    ...
                    for (var c = this.findLineage(a), d = this.findLineage(b), e = 0; c[e] === d[e];)
                        e++;
                    return {
                            ...
                            for (var l = 0; l < h; l++)
                                if (k !== l) {
                                    var m = d[k],
                                        ...
                                        q = -1,
                                        r = -1;
                                    "x" == a ? f(o, p) && (m[0][b] < m[1][b] ? (q = l, r = k) : (q = k, r = l)) : f(o, p) && (m[0][b] < m[1][b] ? (q = k, r = l) : (q = l, r = k)),
                                    q >= 0 && j.push(new e.Constraint(i[q], i[r], g))
                                }
                        new e.Solver(i, j).solve(),
                    ...
                    for (var g = a.getSegmentSets(b, c, d), h = 0; h < g.length; h++) {
                        ...
                        j.forEach(function(g) {
                            0 === g.type ? (m.push(g.s), n++) : n--,
                            0 == n && (a.nudgeSegs(c, d, b, m, e, f), m = [])
                        })
                    }
                    ...
                    if (b.length > 1)
                        for (var g = 0; g < b.length; g++) {
                            var h = b[g],
                                ...
                                l = j - h[0].y;
                            if (g < b.length - 1) {
                                Math.abs(k) > 0 ? i -= k / Math.abs(k) * c : j -= l / Math.abs(l) * c,
                                f.routepath += "L " + i + " " + j + " ";
                                var m = b[g + 1],
                                    n = m[0].x,
                                    o = m[0].y,
                                ...
                                var w,
                                    x,
                                    y = [i, j];
                                Math.abs(k) > 0 ? (i -= k / Math.abs(k) * e, w = [i, j + d], x = [i, j - d]) : (j -= l / Math.abs(l) * e, w = [i + d, j], x = [i - d, j]),
                                f.routepath += "L " + i + " " + j + " ",
                                e > 0 && (f.arrowpath = "M " + y[0] + " " + y[1] + " L " + w[0] + " " + w[1] + " L " + x[0] + " " + x[1])
                            }
                        }
                    else {
                        var w,
        ...
        10: [function(a, b, c) {
            ...
            function d(a, b, c, d, e, g) {
                ...
                function i(a, b) {
                    for (var c = void 0, d = 0; d < t.length; d++)
                        if (t[d].space_left >= a.height && t[d].x + t[d].width + a.width + f.PADDING - b <= f.FLOAT_EPSILON) {
                            c = t[d];
                            break
                        }
                    t.push(a),
                    void 0 !== c ? (a.x = c.x + c.width + f.PADDING, a.y = c.bottom, a.space_left = a.height, a.bottom = a.y, c.space_left -= a.height + f.PADDING, c.bottom += a.height + f.PADDING) : (a.y = s, s += a.height + f.PADDING, a.x = l, a.bottom = a.y, a.space_left = a.height),
                    a.y + a.height - q > -f.FLOAT_EPSILON && (q = a.y + a.height - m),
                    a.x + a.width - p > -f.FLOAT_EPSILON && (p = a.x + a.width - l)
                }
                function j(a) {
                    var b = 0;
                ...
                0 != a.length && (function(a) {
                    ...
                    for (var e = p = r, g = q = j(a), i = 0, k = Number.MAX_VALUE, l = Number.MAX_VALUE, m = -1, n = Number.MAX_VALUE, o = Number.MAX_VALUE; n > r || o > f.FLOAT_EPSILON;) {
                        if (1 != m)
                            var p = g - (g - e) / f.GOLDEN_SECTION,
                                k = h(a, p);
                        if (0 != m)
                            var q = e + (g - e) / f.GOLDEN_SECTION,
                                l = h(a, q);
                        if (n = Math.abs(p - q), o = Math.abs(k - l), k < c && (c = k, d = p), l < c && (c = l, d = q), k > l ? (e = p, p = q, k = l, m = 1) : (g = q, q = p, l = k, m = 0), i++ > 100)
                            break
                    }
                    h(a, d)
                }(a), g && function(a) {
            ...
            function e(a, b) {
                ...
                for (var d = {}, e = {}, f = [], g = 0, h = 0; h < b.length; h++) {
                    var i = b[h],
                        j = i.source,
                        k = i.target;
                    e[j.index] ? e[j.index].push(k) : e[j.index] = [k],
                    e[k.index] ? e[k.index].push(j) : e[k.index] = [j]
                }
            ...
            var m = function() {
                ...
                return a.prototype.on = function(a, b) {
                    ...
                    if (this._alpha < this._threshold)
                        return this._running = !1, this.trigger({
                            type: e.end,
                            alpha: this._alpha = 0,
                    ...
                    this._links.length;
                    for (this._descent.locks.clear(), b = 0; b < c; ++b)
                        if (a = this._nodes[b], a.fixed) {
                    ...
                    for (var a, b = this._descent.x[0], c = this._descent.x[1], d = this._nodes.length; d--;)
                        a = this._nodes[d],
                        a.x = b[d],
                        a.y = c[d]
                    ...
                    return a ? (this._groups = a, this._rootGroup = {}, this._groups.forEach(function(a) {
                        void 0 === a.padding && (a.padding = 1),
                        void 0 !== a.leaves && a.leaves.forEach(function(c, d) {
                    ...
                    this._distanceMatrix ? v = this._distanceMatrix : (v = new j.Calculator(o, this._links, a.getSourceIndex, a.getTargetIndex, function(a) {
                        ...
                        "number" == typeof a.source && (a.source = l._nodes[a.source]),
                        "number" == typeof a.target && (a.target = l._nodes[a.target])
                    ...
                    this._directedLinkConstraints && (this.linkAccessor.getMinSeparation = this._directedLinkConstraints.getMinSeparation, y = y.concat(g.generateDirectedEdgeConstraints(n, this._links, this._directedLinkConstraints.axis, this.linkAccessor))),
                    this.avoidOverlaps(!1),
                    this._descent = new h.Descent([r, s], w),
                    ...
                    if (this._descent.threshold = this._threshold, this.initialLayout(b, r, s), y.length > 0 && (this._descent.project = new i.Projection(this._nodes, this._groups, this._rootGroup, y).projectFunctions()), this._descent.run(c), this.separateOverlappingComponents(p, q, k), this.avoidOverlaps(u), u && (this._nodes.forEach(function(a, b) {
                        ...
                        this._descent.scaleSnapByMaxH = n != o;
                    ...
                    if (this._groups.length > 0 && b > 0) {
                        ...
                        (new a).size(this.size()).nodes(g).links(f).avoidOverlaps(!1).linkDistance(this.linkDistance()).symmetricDiffLinkLengths(5).convergenceThreshold(1e-4).start(b, 0, 0, 0, !1),
                        this._nodes.forEach(function(a) {
                            c[a.index] = g[a.index].x,
                            d[a.index] = g[a.index].y
                        })
                    } else
                        this._descent.run(b)
                    ...
                    if (void 0 === c && (c = !0), !this._distanceMatrix && this._handleDisconnected) {
                        ...
                        l.applyPacking(g, a, b, this._defaultNodeSize, 1, c),
                        this._nodes.forEach(function(a, b) {
                            d._descent.x[0][b] = a.x,
                            d._descent.x[1][b] = a.y,
                            a.bounds && (a.bounds.setXCentre(a.x), a.bounds.setYCentre(a.y))
                        })
                    }
                    ...
                    void 0 === a && (a = 0),
                    this._visibilityGraph = new k.TangentVisibilityGraph(this._nodes.map(function(b) {
                    ...
                    e.addEdgeIfVisible(f, g, a.source.index, a.target.index),
                    void 0 !== c && c(e);
                    var m = function(a) {
                            return a.source.id
                        },
                    ...
                    if (1 === q.length || q.length === e.V.length) {
                        ...
                        for (var s = q.length - 2, t = e.V[q[s]].p, u = e.V[q[0]].p, d = [a.source.innerBounds.rayIntersection(t.x, t.y)], v = s; v >= 0; --v)
                            d.push(e.V[q[v]].p);
                    ...
                    void 0 !== b.leaves && b.leaves.forEach(function(b) {
                        b.fixed |= 2,
                        a.stopNode(b),
                        b._dragGroupOffsetX = b.x - c.x,
                        b._dragGroupOffsetY = b.y - c.y
                    }),
                    ...
                    d(b) ? (void 0 !== b.leaves && b.leaves.forEach(function(a) {
                        b.bounds.setXCentre(c.x),
                        b.bounds.setYCentre(c.y),
                        a.px = a._dragGroupOffsetX + c.x,
                        a.py = a._dragGroupOffsetY + c.y
                    }), void 0 !== b.groups && b.groups.forEach(function(b) {
                        return a.drag(b, c)
                    })) : (b.px = c.x, b.py = c.y)
                    ...
                    d(b) ? (void 0 !== b.leaves && b.leaves.forEach(function(b) {
                        a.dragEnd(b),
                        delete b._dragGroupOffsetX,
                        delete b._dragGroupOffsetY
        ...
        12: [function(a, b, c) {
            ...
            var j = function() {
                function a(b, c, d) {
                    ...
                    this.nodes = b,
                    this.links = c,
                    this.idealLinkLength = d,
                    this.constraints = null,
                    this.useJaccardLinkLengths = !0,
                    this.result = new Array(a.k);
                    for (var f = 0; f < a.k; ++f)
                        this.result[f] = new Array(b.length);
                ...
                return a.prototype.linkLength = function(a) {
                    ...
                    var c = this.nodes.length,
                        h = new k;
                    this.useJaccardLinkLengths && g.jaccardLinkLengths(this.links, h, 1.5),
                    ...
                    this.descent = new e.Descent(this.result, j),
                    this.descent.threshold = .001,
                    this.descent.G = l,
                    this.constraints && (this.descent.project = new f.Projection(this.nodes, null, null, this.constraints).projectFunctions());
        ...
        13: [function(a, b, c) {
            ...
            c.symmetricDiffLinkLengths = h,
            c.jaccardLinkLengths = i,
            c.generateDirectedEdgeConstraints = j,
            c.stronglyConnectedComponents = k
        }, {}],
        14: [function(a, b, c) {
            "use strict";
            function d(a, b, c) {
            ...
            var h = function() {
                function a(a, b, c, d) {
                    var e = this;
                    if (this.linkAccessor = c, this.modules = new Array(a), this.roots = [], d)
                        this.initModulesFromGroup(d);
                    else {
                        this.roots.push(new j);
                        for (var f = 0; f < a; ++f)
                            this.roots[0].add(this.modules[f] = new i(f))
                    }
                    this.R = b.length,
                ...
                return a.prototype.initModulesFromGroup = function(a) {
                    ...
                    if (a.groups)
                        for (var f = 0; f < a.groups.length; ++f) {
                            var g = a.groups[f],
                                h = {};
                            for (var l in g)
                                "leaves" !== l && "groups" !== l && g.hasOwnProperty(l) && (h[l] = g[l]);
                    ...
                    void 0 === a && (a = 0);
                    for (var b = this.roots[a].modules(), c = b.length, d = new Array(c * (c - 1)), e = 0, f = 0, g = c - 1; f < g; ++f)
                        for (var h = f + 1; h < c; ++h) {
                            var i = b[f],
                                j = b[h];
                            d[e] = {
            ...
            var k = function() {
                ...
                return a.prototype.count = function() {
                    ...
                    (a in this.sets ? this.sets[a] : this.sets[a] = new j).add(b),
                    ++this.n
                }, a.prototype.remove = function(a, b) {
                    var c = this.sets[a];
                    c.remove(b),
                    0 === c.count() && delete this.sets[a],
                    --this.n
                }, a.prototype.forAll = function(a) {
                    for (var b in this.sets)
                        a(this.sets[b], Number(b))
        ...
        15: [function(a, b, c) {
            ...
            var d = function() {
                ...
                return a.prototype.toString = function(a) {
                    ...
                    var f = b.removeMin(e);
                    b.elem = f.elem,
                    b.subheaps = f.subheaps,
                    null !== d && null !== f.elem && d(b.elem, b);
                    var g = new a(c);
            ...
            var e = function() {
                ...
                return a.prototype.top = function() {
                    ...
                    for (var a = [], b = 0; b < arguments.length; b++)
                        a[b] = arguments[b];
                    for (var c, e, f = 0; e = a[f]; ++f)
                        c = new d(e),
                        this.root = this.empty() ? c : this.root.merge(c, this.lessThan);
                    return c
                }, a.prototype.empty = function() {
                    ...
                    void 0 === c && (c = null),
                    this.root = this.root.decreaseKey(a, b, c, this.lessThan)
        ...
        16: [function(a, b, c) {
            ...
            var e = function() {
                ...
                return a.prototype.clear = function() {
                    ...
                    for (var b, c = this.iterator(); null !== (b = c.next());)
                        a(b)
                }, a.prototype.reach = function(a) {
                    for (var b, c = this.iterator(); null !== (b = c.prev());)
                        a(b)
                }, a.prototype._bound = function(a, b) {
                    for (var c = this._root, d = this.iterator(); null !== c;) {
                        var e = this._comparator(a, c.data);
                        if (0 === e)
                            return d._cursor = c, d;
                        d._ancestors.push(c),
                        c = c.get_child(e > 0)
                    }
                    for (var f = d._ancestors.length - 1; f >= 0; --f)
                        if (c = d._ancestors[f], b(a, c.data) > 0)
                            return d._cursor = c, d._ancestors.length = f, d;
                ...
                h = function(a) {
                    ...
                    return d(b, a), b.prototype.insert = function(a) {
                        ...
                        for (var e = null, f = null, h = null, i = !0; null !== d.get_child(i);) {
                            ...
                            if (i = k > 0, 0 === k && (h = d), !b.is_red(d) && !b.is_red(d.get_child(i)))
                                if (b.is_red(d.get_child(!i))) {
                                    ...
                                    var m = e.get_child(!j);
                                    if (null !== m)
                                        if (b.is_red(m.get_child(!j)) || b.is_red(m.get_child(j))) {
                                            var n = f.right === e;
        ...
        17: [function(a, b, c) {
            ...
            function i(a, b, c, d) {
                ...
                if (d) {
                    var p = a.bounds,
                        ...
                        u = q - r + e / 2,
                        v = q + r - e / 2;
                    a.minVar.desiredPosition = u,
                    o(b.makeRect(s, t, u, e), a.minVar),
                    a.maxVar.desiredPosition = v,
                    o(b.makeRect(s, t, v, e), a.maxVar)
                }
            ...
            function j(a, b, c, d) {
                ...
                for (e = 0; e < f; ++e) {
                    ...
                    j[e] = new w(!0, l, c.getOpen(k)),
                    j[e + f] = new w(!1, l, c.getClose(k))
                }
                j.sort(g);
                var m = new Array,
                    n = h();
                for (e = 0; e < i; ++e) {
                    ...
                    if (o.isOpen)
                        ...
                        var p = function(a, b) {
                            ...
                            q = function(a, b, c) {
                                for (var d, e = l[a].iterator(); null !== (d = e[a]());)
                                    c(d, l),
                                    d[b].remove(l)
                            };
            ...
            function k(a, b) {
                var c = function(c, d) {
                    for (var e, f = b.findIter(a); null !== (e = f[c]());) {
                        ...
                        if ((g <= 0 || g <= e.r.overlapY(a.r)) && (a[c].insert(e), e[d].insert(a)), g <= 0)
                            break
                    }
                };
                c("next", "prev"),
            ...
            c.generateXConstraints = m,
            c.generateYConstraints = n,
            c.generateXGroupConstraints = o,
            c.generateYGroupConstraints = p,
            c.removeOverlaps = q;
            var z = function(a) {
                function b(b, c) {
            ...
            var A = function() {
                function a(a, b, c, e, f) {
                    ...
                    if (void 0 === c && (c = null), void 0 === e && (e = null), void 0 === f && (f = !1), this.nodes = a, this.groups = b, this.rootGroup = c, this.avoidOverlaps = f, this.variables = a.map(function(a, b) {
                        ...
                        a.forEach(function(a) {
                            if (!a.width || !a.height)
                                return void (a.bounds = new u(a.x, a.x, a.y, a.y));
                            var b = a.width / 2,
                                c = a.height / 2;
                        ...
                        var h = a.length;
                        b.forEach(function(a) {
                            g.variables[h] = a.minVar = new z(h++, void 0 !== a.stiffness ? a.stiffness : .01),
                            g.variables[h] = a.maxVar = new z(h++, void 0 !== a.stiffness ? a.stiffness : .01)
                        })
                    }
                }
                return a.prototype.createSeparation = function(a) {
                    ...
                    this.setupVariablesAndBounds(a, b, e, f),
                    this.rootGroup && this.avoidOverlaps && (d(this.rootGroup), g = g.concat(h(this.rootGroup))),
                    this.solve(this.variables, g, c, e),
                    this.nodes.forEach(i),
                    this.rootGroup && this.avoidOverlaps && (this.groups.forEach(j), d(this.rootGroup))
                }, a.prototype.solve = function(a, b, c, d) {
                    var e = new s.Solver(a, b);
                    e.setStartingPositions(c),
                    e.setDesiredPositions(d),
                    e.solve()
                }, a
            }();
            c.Projection = A
            ...
            var d = a("./pqueue"),
                ...
                h = function() {
                    function a(a, b, c, d, g) {
                        ...
                        for (var h = this.n; h--;)
                            this.neighbours[h] = new f(h);
                        for (h = this.es.length; h--;) {
                            var i = this.es[h],
                                j = c(i),
                                k = d(i),
                                l = g(i);
                            this.neighbours[j].neighbours.push(new e(k, l)),
                            this.neighbours[k].neighbours.push(new e(j, l))
                        }
                    }
                    return a.prototype.DistanceMatrix = function() {
                        for (var a = new Array(this.n), b = 0; b < this.n; ++b)
                            a[b] = this.dijkstraNeighbours(b);
                        return a
                        ...
                        var e = new d.PriorityQueue(function(a, b) {
                            ...
                            h = new g(f, null, 0),
                            i = {};
                        for (e.push(h); !e.empty() && (h = e.pop(), f = h.node, f.id !== b);)
                            for (var j = f.neighbours.length; j--;) {
                        ...
                        for (var c = new d.PriorityQueue(function(a, b) {
                            ...
                            g.d = e === a ? 0 : Number.POSITIVE_INFINITY,
                            g.q = c.push(g)
                        }
                        for (; !c.empty();) {
                            var h = c.pop();
                            if (f[h.id] = h.d, h.id === b) {
                                for (var i = [], j = h; void 0 !== j.prev;)
                                    i.push(j.prev.id),
                                    j = j.prev;
                                return i
                            }
        ...
        19: [function(a, b, c) {
            ...
            var h = function() {
                function a(a) {
                    this.vars = [],
                    a.offset = 0,
                    this.ps = new e(a.scale),
                    this.addVariable(a)
                }
                return a.prototype.addVariable = function(a) {
                    a.block = this,
                    this.vars.push(a),
                    this.ps.addVariable(a),
                    this.posn = this.ps.getPosn()
                }, a.prototype.updateWeightedPosition = function() {
                    this.ps.AB = this.ps.AD = this.ps.A2 = 0;
                    for (var a = 0, b = this.vars.length; a < b; ++a)
                        this.ps.addVariable(this.vars[a]);
                    this.posn = this.ps.getPosn()
                    ...
                    return a.visitNeighbours(b, function(b, f) {
                        ...
                        f === b.right ? (e += g * b.left.scale, b.lm = g) : (e += g * b.right.scale, b.lm = -g),
                        c(b)
                    }), e / a.scale
                }, a.prototype.populateSplitBlock = function(a, b) {
                    var c = this;
                    a.visitNeighbours(b, function(b, d) {
                        d.offset = a.offset + (d === b.right ? b.gap : -b.gap),
                        c.addVariable(d),
                        c.populateSplitBlock(d, a)
                    })
                }, a.prototype.traverse = function(a, b, c, d) {
                    var e = this;
                    void 0 === c && (c = this.vars[0]),
                    void 0 === d && (d = null),
                    c.visitNeighbours(d, function(d, f) {
                        b.push(a(d)),
                        e.traverse(a, b, f, c)
                    })
                    ...
                    for (var c = a.cOut.length; c--;) {
                        var d = a.cOut[c];
                        if (d.active && this.isActiveDirectedPathBetween(d.right, b))
                            return !0
                    }
                    return !1
                }, a.split = function(b) {
            ...
            var i = function() {
                ...
                return a.prototype.cost = function() {
                    for (var a = 0, b = this.list.length; b--;)
                        a += this.list[b].cost();
                    return a
                }, a.prototype.insert = function(a) {
                    a.blockInd = this.list.length,
                    this.list.push(a)
                }, a.prototype.remove = function(a) {
                    var b = this.list.length - 1,
                        c = this.list[b];
                    this.list.length = b,
                    a !== c && (this.list[a.blockInd] = c, c.blockInd = a.blockInd)
            ...
            var j = function() {
                ...
                return a.prototype.cost = function() {
                    ...
                    this.bs = new i(this.vs),
                    this.bs.forEach(function(b, c) {
                        return b.posn = a[c]
                    })
                    ...
                    for (var b = null; (b = this.mostViolated()) && (b.equality || b.slack() < a.ZERO_UPPERBOUND && !b.active);) {
                        ...
                        if (c !== b.right.block)
                            ...
                            this.bs.insert(d.rb),
                            this.bs.remove(c),
                            this.inactive.push(d.constraint),
                            b.slack() >= 0 ? this.inactive.push(b) : this.bs.merge(b)
                        }
                    }
                }, a.prototype.solve = function() {
                    this.satisfy();
                    for (var a = Number.MAX_VALUE, b = this.bs.cost(); Math.abs(a - b) > 1e-4;)
                        this.satisfy(),
                        a = b,
                        b = this.bs.cost();
                    return b
            ...
            c.Solver = j,
            c.removeOverlapInOneDimension = d
        }, {}]
    }, {}, [1])(1)
});
